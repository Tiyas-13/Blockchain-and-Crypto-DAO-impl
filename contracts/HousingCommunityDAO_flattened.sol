...
// File: contracts/GameEmporium.sol
...
// File: contracts/NFTs/ParkingPassNFT.sol
...
contract ParkingPassNFT is ERC721, Ownable {
    uint256 private _nextTokenId;

    constructor(address initialOwner)
        ERC721("ParkingPassNFT", "PKFT")
...
// File: contracts/NFTs/PoolAccessNFT.sol
...
contract PoolAccessNFT is ERC721, Ownable {
    uint256 private _nextTokenId;

    constructor(address initialOwner)
        ERC721("PoolAccessNFT", "PLFT")
        Ownable(initialOwner)
    {}
...
// File: contracts/NFTs/GymMembershipNFT.sol
...
contract GymMembershipNFT is ERC721, Ownable {
    uint256 private _nextTokenId;

    constructor(address initialOwner)
        ERC721("GymMembershipNFT", "GFT")
        Ownable(initialOwner)
    {}
...
// File: contracts/CommunityIncentives.sol
...
// File: contracts/Tokens/ParticipationToken.sol
...
// File: contracts/Tokens/VoteToken.sol
...
contract VoteToken is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    constructor(address initialOwner)
    ...
    function transferVoterumTo(address from, address to, uint256 amount) public returns (bool){
        approve(from, amount * (10 ** uint256(decimals())));
        return transferFrom(from, to, amount * (10 ** uint256(decimals())));
    }
}
// File: contracts/HousingCommunityDAO.sol
