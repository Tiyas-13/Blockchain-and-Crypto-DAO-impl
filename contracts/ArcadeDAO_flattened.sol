...
// File: contracts/GymMembershipToken.sol
...
contract GymMembershipToken is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    constructor(address initialOwner)
        ERC20("GymMembershipToken", "GYM")
        Ownable(initialOwner)
        ERC20Permit("GymMembershipToken")
    {}
    ...
    function transferGymMembershipTokenTo(address from, address to, uint256 amount) public returns (bool){
...
contract Votereum is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    constructor(address initialOwner)
        ERC20("Votereum", "VOTE")
        Ownable(initialOwner)
        ERC20Permit("Votereum")
    {}
